...
thousand-triangle mesh, could put a 57 ms stall on a fifth of your frames,
while thirty other mesh props
in the same scene cost nothing at all. The geometry was never the problem:
