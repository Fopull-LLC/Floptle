...
A single node with **Collidable** and **Trigger** on a thousand-triangle mesh
could put a 57 ms stall on a fifth of your frames, while thirty other mesh props
...
Triggers reject by bounds first now. If you dropped **Trigger** from a node to
get your frame rate back, you can put it back.
