...
const LUA_API: &[ApiEntry] = &[
    ...
    ApiEntry { label: "nav.AREA_STRIDE", insert: "nav.AREA_STRIDE", doc: "How many numbers nav.areas() uses per area (10). Read it rather than writing the number, so a future field costs nothing." },
