...
// Including a real source file pulls in the whole of it, and a probe uses one
// corner. The alternative to allowing dead code here is trimming the module to
// what this example happens to touch, which is the copy this is written to not
// have.
#[allow(dead_code)]
mod anim {
    use std::path::Path;
